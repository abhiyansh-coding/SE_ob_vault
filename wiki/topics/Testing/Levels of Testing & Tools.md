...
# Levels of Testing & Tools

**Prerequisites:** [[Black-Box Testing]], [[White-Box Testing]]
...
> as an absence of evidence, not evidence of absence. Lectures 42 is
> *syllabus depth* and rule 3 forbids reading it as marks.

Unit, integration, system and validation testing — what each level can and cannot catch — plus static and dynamic testing tools.
