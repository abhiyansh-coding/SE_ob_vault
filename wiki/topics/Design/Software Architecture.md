...
> as an absence of evidence, not evidence of absence. Lectures 27, 29-30 is
> *syllabus depth* and rule 3 forbids reading it as marks.

Control hierarchy, structural partitioning, data design and the data warehouse; then comparing alternative architectural designs and scoring architectural complexity.
